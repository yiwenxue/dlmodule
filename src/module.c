...
int modunload(struct mod_list_h *mlist_hp,
        struct module *mod)
{
#if debug 
...
int modpop(struct mod_list_h *mlist_hp,
        struct module *mod)
{
...
int modctl_load(struct mod_list_h *mlist_hp,
        char *mod_name){
    return modload(mlist_hp, mod_name);
}

int modctl_unload(struct mod_list_h *mlist_hp,
        char * mod_name){
